...
function pauseTrip(){ if(watchId){ navigator.geolocation.clearWatch(watchId); watchId=null; setStatus('warn','일시정지'); } }
function resumeTrip(){ if(!watchId) startTrip(); }
function endTrip(){ if(watchId){ navigator.geolocation.clearWatch(watchId); watchId=null; } $('#status-indicator').classList.add('hidden'); }
